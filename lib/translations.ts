...
export const translations: Record<Language, Translations> = {
  ...
  kn: {
    ...
    historyDeities: "ಲಾರ್ಡ್ ಗಣಪತಿ, ದೇವಿ ಪಾರ್ವತಿ ಮತ್ತು ನವಗ್ರಹ ದೇವತೆಗಳನ್ನು ಸಮುದಾಯ ಬೆಂಬಲದೊಂದಿಗೆ ಸ್ಥಾಪಿಸಲಾಯಿತು, ಎಲ್ಲಾ ಭಕ್ತರಿಗಾಗಿ ಸಮಗ್ರ ಆಧ್ಯಾತ್ಮಿಕ ಆಶ್ರಯವನ್ನು ಸೃಷ್ಟಿಸಿತು.",
    ...
    historyService: "1990 ರಿಂದ, ದೇವಸ್ಥಾನವು ಸಾವಿರಾರು ಭಕ್ತರಿಗೆ ಸೇವೆ ಸಲ್ಲಿಸಿದೆ. ಅನೇಕರು ತಮ್ಮ ಪ್ರಾರ್ಥನೆಗಳಿಗೆ ಉತ್ತರ ದೊರೆತಿದೆ ಎಂದು ಸಾಕ್ಷ್ಯ ನೀಡುತ್ತಾರೆ, ವಿಶೇಷವಾಗಿ ವಿವಾಹ ವ್ಯವಸ್ಥೆಗಳು ಮತ್ತು ಸಂತತಿಯ ಕುರಿತು, ಲಾರ್ಡ್ ಶಿವರ ದೈವಿಕ ಕೃಪೆಯ ಮೂಲಕ. ದೇವಸ್ಥಾನದ ಬೆಳವಣಿಗೆ ಟ್ರಸ್ಟಿಗಳ ಸಮರ್ಪಿತ ಸೇವೆ ಮತ್ತು ಭಕ್ತರ ಉದಾರ ಬೆಂಬಲದ ಮೂಲಕ ಸಾಧ್ಯವಾಗಿದೆ.",
    ...
    deitiesDescription: "ಲಾರ್ಡ್ ಗಣಪತಿ, ದೇವಿ ಪಾರ್ವತಿ ಮತ್ತು ನವಗ್ರಹ ದೇವತೆಗಳನ್ನು ಸಮುದಾಯ ಬೆಂಬಲದೊಂದಿಗೆ ಸ್ಥಾಪಿಸಲಾಯಿತು, ಎಲ್ಲಾ ಭಕ್ತರಿಗಾಗಿ ಸಮಗ್ರ ಆಧ್ಯಾತ್ಮಿಕ ಆಶ್ರಯವನ್ನು ಸೃಷ್ಟಿಸಿತು.",
    ...
    // Deity Names
    lordGanesha: "ಲಾರ್ಡ್ ಗಣೇಶ",
    lordShivaLingam: "ಲಾರ್ಡ್ ಶಿವಲಿಂಗ",
    goddessParvati: "ದೇವಿ ಪಾರ್ವತಿ",
    lordHanuman: "ಲಾರ್ಡ್ ಹನುಮಂತ",
  }
}
